...
public class VEmpresa extends javax.swing.JFrame {
    ...
    panelGeneral.addTab("Ofertar participaciones", tabs10);
    ...
    layout.setHorizontalGroup(
        ...
        .addGroup(layout.createSequentialGroup()
            ...
            .addComponent(panelGeneral, javax.swing.GroupLayout.PREFERRED_SIZE, 807, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addGap(56, 56, 56))
    );
    layout.setVerticalGroup(
        ...
        .addGroup(layout.createSequentialGroup()
            .addGap(43, 43, 43)
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                .addComponent(panelGeneral, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 637, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGroup(layout.createSequentialGroup()
                    .addComponent(bienvenidoLabel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(18, 18, 18)
                    .addComponent(usuarioLabel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
...
pack();
    ...
    private void bajaBotonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bajaBotonActionPerformed
          if (fa.getNumeroParticipaciones(e.getIdUsuario(), "Empresa") == 0 && fa.getNumOfertaVenta(e.getIdUsuario())==0) {
        ...
        } else if(fa.getNumOfertaVenta(e.getIdUsuario())!=0){
    ...
    private void anunciarBeneficios() {
        ...
        if (!importeTextBox.validateInput() & !numParticipacionesAnuncioTextBox.validateInput()) {
            FachadaGUI.muestraExcepcion("Por favor, introduzca un número de participaciones y/o un importe por participación\n"
        ...
        if (!FechaTextBox.validateInput()) {
            if (FechaTextBox.getFecha() == null) {
                FachadaGUI.muestraExcepcion("La fecha introducida no es válida!", DialogoInfo.NivelDeAdvertencia.ADVERTENCIA);
            } else {
                FachadaGUI.muestraExcepcion("La fecha introducida no está especificada en el futuro!", DialogoInfo.NivelDeAdvertencia.ADVERTENCIA);
            }
            return;
        }
    ...
    public void solicitarBajaAnuncio() {
        ...
        if (fila == -1) {
            FachadaGUI.muestraExcepcion("No se ha seleccionado ningún anuncio");
            return;
        }
    ...
    public void Pagar() {
        ...
        if (fila != -1) {
            ...
            if (!importeTextBox.validateInput() & !numParticipacionesAnuncioTextBox.validateInput()) {
                ...
                FachadaGUI.muestraExcepcion(msg, DialogoInfo.NivelDeAdvertencia.ADVERTENCIA);
                return;
            }
            // Puede que importe o numero sea nulo (nunca ambas)
            float importe = !importeTextBox.validateInput() ? 0.0f : Float.parseFloat(importeTextBox.getText());
    ...
    public void emitirParticipaciones() {
        ...
        if (!numeroParticipacionesTextBox.validateInput()) {
            if (numeroParticipacionesTextBox.getText().isEmpty()) {
                FachadaGUI.muestraExcepcion("El número de participaciones no se ha introducido!", DialogoInfo.NivelDeAdvertencia.ADVERTENCIA);
            } else {
                FachadaGUI.muestraExcepcion("El número de participaciones no es correcto!", DialogoInfo.NivelDeAdvertencia.ADVERTENCIA);
            }
            return;
        }
    ...
    public void eliminarParticipaciones() {
        ...
        if (cantidad > this.numeroParticipaciones) {
            FachadaGUI.muestraExcepcion("No se poseen tantas participaciones!", DialogoInfo.NivelDeAdvertencia.ADVERTENCIA);
            return;
        }
        if (cantidad == 0) {
            return;
